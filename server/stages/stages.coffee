  ...
  deploy:
    ...
    cmd:
      ...
      """
        ...
        rsync -avz --delete --exclude 'programs/server/node_modules' --exclude '.meteor/files/' -e "ssh -p ${SSH_PORT} -oBatchmode=yes" var/meteor/${REPO} ${SSH_USER}@${SSH_HOST}:/var/meteor
